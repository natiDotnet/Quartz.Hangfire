...
public static partial class QuartzJob
{
    ...
    private static async Task AddOrUpdate(string recurringJobId, Job job, string cronExpression, RecurringJobOptions? options = null, ISchedulerFactory? factory = null, IScheduler? scheduler = null)
    {
        ...
        var jobKey = JobKey.Create(recurringJobId);
        // var recurringJob = await scheduler.GetJobDetail(JobKey.Create(recurringJobId));
        // recurringJob.GetJobBuilder()
        ...
        //         }
        //     }).Build();
        // IJobDetail expressionJob = recurringJob ?? JobBuilder.Create<ExpressionJob>()
        ...
        //     .Build();
            ...
            var trigger = TriggerBuilder.Create()
                ...
                .StartNow()
                .WithCronSchedule(CronConverter.Convert(cronExpression),
